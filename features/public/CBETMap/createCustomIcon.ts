  ...
  L.divIcon({
    ...
    html: `
      ...
      <div class="relative group">
        ...
        <div class="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center shadow-xl border-2 border-white"
          style="animation: cbet-marker-pulse 1.6s ease-in-out infinite;">
