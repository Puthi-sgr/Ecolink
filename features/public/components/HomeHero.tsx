  ...
  return (
    <div className="relative w-full pb-16 bg-surface-2 mb-12"> 
      ...
      <div className="absolute inset-0 h-[500px] z-0 overflow-hidden bg-primary-600">
        ...
        />
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-primary-600/80 to-primary-500/80"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-primary-600/50 via-transparent to-transparent"></div>
      </div>
