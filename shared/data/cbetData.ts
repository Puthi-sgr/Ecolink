...
export const CBET_PACKAGES: BasePackage[] = [
  ...
  },
  {
    ...
    imageKey: 'cbet.package.veunsaisiampang.community.profile',
    isFavorite: false,
  ...
  },
  {
    ...
    bookingConditions: { minLeadTimeDays: 14, minGroupSize: 15, maxGroupSize: 35, cancellationPolicy: '30% deposit is non-refundable. Balance due 2 days prior; non-refundable after payment.', transportNotes: 'Boat ferry across the Sesan River and motorbike transfers from Banlung are included.' }
  }
...
export const MOCK_TRIPS: Trip[] = [
  ...
  },
  {
    id: 'EL-2024-0105',
    packageId: 'CBET-016',
    packageName: 'Veun Sai-Siem Pang Gibbon Experience',
    facultyName: 'Dr. Sarah Jenning',
    department: 'Environmental Science',
    requestorContact: 's.jenning@ecolink.edu',
    date: '2024-12-05',
